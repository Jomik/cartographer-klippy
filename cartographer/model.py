...
from cartographer import polynomial

MODEL_PREFIX = "cartographer model "
...
class CalibrationModel:
    ...
    @staticmethod
    def load(config: ConfigWrapper, name: str) -> CalibrationModel:
        ...
        return CalibrationModel(printer, name, poly, temperature, min_z, max_z)
    ...
    def distance_to_frequency(self, distance: float, max_e: float = 1e-8) -> float:
        ...
        raise self.printer.command_error("Scanner model convergence error")
